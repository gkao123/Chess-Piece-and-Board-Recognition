...
newtrainingFeatures = reshape(trainingFeatures, 1, [])
...
% features.
classifier = fitcecoc(newtrainingFeatures, trainingLabels, ...
...
newtestFeatures = reshape(testFeatures, 1, [])

% Pass CNN image features to trained classifier
predictedLabels = predict(classifier, newtestFeatures, 'ObservationsIn', 'columns');
